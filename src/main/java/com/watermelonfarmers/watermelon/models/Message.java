...
public class Message {
    ...
    public Message(long id,
            @NotEmpty(message = "message is a required field", groups = Create.class) @Size(max = 255, message = "message can not be more than 255 characters", groups = {
                    Create.class, Update.class }) String message,
